...
PyVESC (updated for modified Vesc Firmware 3.33 (https://github.com/raess1/vesc-FW)) is aimed at being a easy to use and robust python implementation of the
